...
if settings.startup["laserfix-color"].value == "'Disco'" then
	...
	data.raw.beam[laserBeam].head.layers[1].filename = graphics_location .. path .. "beam-body-color.png"
	data.raw.beam[laserBeam].head.layers[1].tint = {r=r,g=g,b=b}
	data.raw.beam[laserBeam].head.layers[2].filename = graphics_location .. path .. "beam-body-light.png"
	...
	data.raw.beam[laserBeam].tail.layers[1].filename = graphics_location .. path .. "beam-end-color.png"
	data.raw.beam[laserBeam].tail.layers[1].tint = {r=r,g=g,b=b}
	data.raw.beam[laserBeam].tail.layers[2].filename = graphics_location .. path .. "beam-end-light.png"
...
data.raw.beam[laserBeam].body.layers[1].filename = graphics_location .. path .. "beam-body-color.png"
data.raw.beam[laserBeam].body.layers[1].tint = {r=r,g=g,b=b}
data.raw.beam[laserBeam].body.layers[2].filename = graphics_location .. path .. "beam-body-light.png"
...
data.raw.beam[laserBeam].light_animations.head.filename = graphics_location .. path .. "hr-laser-body-light.png"
data.raw.beam[laserBeam].light_animations.body[1].filename = graphics_location .. path .. "hr-laser-body-light.png"
